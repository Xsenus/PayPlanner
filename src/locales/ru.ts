export const ru = {
  ...
  noCompaniesSelected: 'Компании пока не выбраны',
  noClientsSelected: 'Сотрудники пока не выбраны',
  ...
  refresh: 'Обновить',
  inactive: 'Неактивно',
  lookupFromDadata: 'Заполнить по ИНН',
  dadataFillHint: 'Данные будут подставлены в форму, сохраните карточку для фиксации.',
  dadataNotFound: 'Компания не найдена в сервисе Dadata.',
  dadataUnavailable: 'Не удалось получить данные из сервиса Dadata.',
  enterInnToSearch: 'Введите ИНН для запроса данных.',
  openCompaniesDictionary: 'Выбрать компанию из справочника',
  openClientsDictionary: 'Выбрать сотрудников',
  hideDictionary: 'Скрыть справочник',
  selectCompaniesFromDictionaryHint: 'Выберите компанию из справочника и прикрепите её к карточке.',
  selectClientsFromDictionaryHint: 'Добавьте сотрудников из справочника физических лиц.',
  // Reports
